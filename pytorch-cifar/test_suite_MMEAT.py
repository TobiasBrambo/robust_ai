...
def test_loop(net1, net2, adversary = None, num_tests_per_batch:int = 10, set_train_for_gen: bool = True):
...
def loop_model_checkpoints(directory1, directory2, store_dir):
    ...
    with open(csv_file, mode='w', newline='') as file:
        ...
        regular_acc = test_loop(net1, net2, adversary=None, num_tests_per_batch=num_tests_per_batch)

        adv_acc_1 = test_loop(net1, net2, adversary=adversary, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_2 = test_loop(net1, net2, adversary=adversary_2, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_3 = test_loop(net1, net2, adversary=adversary_3, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_4 = test_loop(net1, net2, adversary=adversary_4, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_5 = test_loop(net1, net2, adversary=adversary_5, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_6 = test_loop(net1, net2, adversary=adversary_6, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_7 = test_loop(net1, net2, adversary=adversary_7, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
        adv_acc_8 = test_loop(net1, net2, adversary=adversary_8, num_tests_per_batch=num_tests_per_batch, set_train_for_gen=True)
...
for first_key, first_value in first_models.items():
    for second_key, second_value in second_models.items():
        ...
        loop_model_checkpoints(first_value, second_value, f"{first_key}_{second_key}")